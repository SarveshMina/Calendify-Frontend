...
<template>
  <div :class="['blue-container', activeCalendar?.color ? `theme-${activeCalendar.color}` : 'theme-blue']">
    ...
    <main class="blue-main">
      ...
      />
      <GroupChat
          v-else-if="activeCalendarId && activeCalendar.isGroup"
          :calendarId="activeCalendarId"
      />
      <p v-else>
...
import GroupChat from '@/components/GroupChat.vue'; // Import GroupChat
...
export default {
  name: 'DashboardView',
  components: { PersonalCalendar, GroupChat, HomeCalendar, ConfirmationModal },
  data() {
    return {
